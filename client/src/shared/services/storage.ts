...
const mmkvStorage = new MMKV({
    id: 'secure.mmkv', // Custom ID for this storage instance
    encryptionKey: 'hunter2', // Encryption key (replace with a strong secret in production)
...
export class StorageService {
    ...
    public getUserData(): string | undefined {
        return this.getString(STORAGE_KEYS.USER_DATA)
    }
